...
import war.reader.mycomponent.MyStreamReaderImpl
import war.transformer.mycomponent.MyStreamTransformerImpl
import war.writer.mycomponent.MyStreamWriterImpl
